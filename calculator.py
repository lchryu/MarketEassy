            ...
            if decision == 1:
                ...
                if preference == 1:
                    ...
                    if alternative == 1:
                        ...
                        t3 = float(
                            input("Mời bạn nhập chiều dài cạnh đáy thứ 1 của hình: ")
                        )
                        u3 = float(
                            input("Mời bạn nhập chiều dài cạnh đáy thứ 2 của hình: ")
                        )
                        v3 = float(
                            input("Mời bạn nhập chiều dài cạnh đáy thứ 3 của hình: ")
                        )
                        ...
                        c4 = float(
                            input("Mời bạn nhập chiều dài cạnh đáy thứ 4 của hình: ")
                        )
